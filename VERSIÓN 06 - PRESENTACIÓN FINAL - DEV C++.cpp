...
#include <vector>       // Para almacenar listas dinÃ¡micas de resultados de bÃºsqueda
#include <algorithm>    // Para funciones como transform() usado en bÃºsqueda de nombres
#include <cstdlib>      // Para funciones del sistema como system("cls")
#include <limits>       // Para lÃ­mites numÃ©ricos (usado en pausar())
#include <cmath>        // Para funciones matemÃ¡ticas como log2() en balanceo
...
void limpiarPantalla() {
    system("cls");  // Comando de Windows para limpiar pantalla
                    // En Linux/Mac será system("clear")
}
...
Nodo* eliminarNodoAux(Nodo* nodo, int id, bool& eliminado) {
    ...
    if (id < nodo->id) {
        ...
        // CASO 3: TIENE DOS HIJOS
            ...
            // ELIMINAR el sucesor del subÃ¡rbol derecho
...
PROPÓSITO
Calcula la ALTURA de un árbol o subárbol
...
La altura es la DISTANCIA MÁXIMA desde un nodo hasta una hoja (el camino más largo hacia abajo)
...
PROPÓSITO: Muestra todos los nodos INTERNOS
UBICACIÓN: Información del árbol
PARÁMETROS:
  - nodo: Nodo actual
						        ...
						        switch (opcionBusqueda) {
						            ...
						            case 2: { // Búsqueda por Año
						                ...
						                if (raiz == NULL) {
						                    ...
						                    mostrarResultados(resultados, "el aÃ±o " + anio);
						                }
						                pausar();
						                break;
						            }
