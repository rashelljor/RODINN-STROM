.-// ============================================================
// ÁRBOL GENEALÓGICO - CIVILIZACIÓN ANTIGUA (VERSIÓN CORREGIDA FINAL)
    ...
    Repetir
        ...
        Segun opcion Hacer
                    ...
                    Segun subopcion Hacer
                        1: // INSERTAR NUEVO MIEMBRO
                            ...
                            Si totalNodos = 0 Entonces
                                ...
                                arbolRol[1] <- rol
                                arbolPadre[1] <- 0  // La raíz no tiene padre
                                Escribir ""
            ...
            2:
				...
				// ==================== INFORMACIÓN DEL ÁRBOL (CORREGIDO) ====================
            3:
                Repetir
                    Limpiar Pantalla
                    ...
                    Segun subopcion Hacer
                        1: // ALTURA DEL ÁRBOL (CORREGIDO)
                            Escribir "--- ALTURA DEL ÁRBOL ---"
                            Si totalNodos = 0 Entonces
                                Escribir "El árbol está vacío (altura = 0)"
                            Sino
                                // Calcular altura real del árbol usando niveles
                                Dimension nivelNodo[100]
                                Para i <- 1 Hasta 100 Hacer
                                    nivelNodo[i] <- -1
                                FinPara
                                
                                nivelNodo[1] <- 0  // La raíz está en nivel 0
                                alturaMaxima <- 0
                                ...
                                Escribir "La altura del árbol es: ", alturaMaxima
                            FinSi
                            Escribir ""
                            Escribir "Presione ENTER para continuar..."
                            Esperar Tecla
                        ...
                        4: // NODOS INTERNOS (CORREGIDO - SIN INCLUIR RAÍZ)
                            Escribir "--- NODOS INTERNOS ---"
                            Si totalNodos = 0 Entonces
                                Escribir "El árbol está vacío"
                            SiNo
                                Si totalNodos = 1 Entonces
                                    Escribir "No hay nodos internos (solo existe la raíz)"
                                Sino
                                    Escribir "Los nodos internos (sin incluir raíz) son:"
                                    hayInternos <- Falso
                                    // Empezar desde 2 para excluir la raíz (índice 1)
                                    ...
                                    Si No hayInternos Entonces
                                        Escribir "No hay nodos internos además de la raíz"
                                    Sino
                                        Escribir ""
                                    FinSi
                                FinSi
				...
				// ==================== OPERACIONES AVANZADAS (TOTALMENTE CORREGIDAS) ====================
            4:
                Repetir
                    Limpiar Pantalla
                    ...
                    Segun subopcion Hacer
                        1: // CAMINO DESDE RAÍZ (CORREGIDO - MUESTRA TODOS LOS NODOS)
                            Escribir "--- CAMINO DESDE RAÍZ A NODO ---"
                            Si totalNodos = 0 Entonces
                                Escribir "El árbol está vacío"
                            Sino
                                // Mostrar IDs disponibles
                                Escribir "IDs disponibles en el árbol:"
                                Escribir "------------------------------------"
                                Para i <- 1 Hasta totalNodos Hacer
                                    Si arbolID[i] <> -1 Entonces
                                        Escribir "ID: ", arbolID[i], " - ", arbolNombre[i]
                                ...
                                Sino
                                    // Reconstruir el camino desde el nodo hacia la raíz
                                    Dimension camino[100]
                                    longitudCamino <- 0
                                    actual <- indiceDestino
                                    
                                    // Ir hacia arriba hasta la raíz
                                    ...
                                    // Mostrar el camino desde la raíz hasta el nodo (invertido)
                        ...
                        2: // LONGITUD DEL CAMINO (CORREGIDA - CUENTA ARISTAS REALES)
                            ...
                            Sino
                                ...
                                Si indiceNodo = -1 Entonces
                                    Escribir "? Nodo no encontrado"
                                Sino
                                    // Contar aristas desde la raíz hasta el nodo
                                    longitudCamino <- 0
                                    actual <- indiceNodo
                                    ...
                                    Escribir "Longitud del camino desde raíz hasta ", id, ": ", longitudCamino, " arista(s)"
                                FinSi
                            FinSi
                            Escribir ""
                            Escribir "Presione ENTER para continuar..."
                        ...
                        3: // ALTURA DE UN NODO (CORREGIDA - CALCULA DESDE EL NODO)
                            ...
                            Sino
                                ...
                                Si indiceNodo = -1 Entonces
                                    Escribir "? Nodo no encontrado"
                                Sino
                                    // Calcular altura del nodo (distancia máxima a una hoja)
                                    // Usar BFS desde el nodo para encontrar el descendiente más lejano
                                    Dimension cola[100]
                                    ...
                                    Escribir "(Distancia máxima desde ", id, " hasta una hoja)"
                                FinSi
                            FinSi
                            Escribir ""
                            Escribir "Presione ENTER para continuar..."
                        ...
                        4: // NIVEL DE UN NODO (CORREGIDO - CALCULA NIVEL REAL)
                            ...
                            Sino
                                ...
                                Si indiceNodo = -1 Entonces
                                    Escribir "? Nodo no encontrado"
                                Sino
                                    // Calcular nivel contando padres hasta la raíz
                                    nivel <- 0
                                    actual <- indiceNodo
                                    ...
                                    Escribir "(La raíz está en nivel 0)"
                                FinSi
                            FinSi
                            Escribir ""
                            Escribir "Presione ENTER para continuar..."
                        ...
                        5: // BALANCEAR ÁRBOL (PROPUESTA DE MEJORA)
                            Escribir "--- BALANCEAR ÁRBOL ---"
                            Escribir ""
                            Escribir "=== PROPUESTA DE MEJORA ==="
                            Escribir ""
                            Escribir "Para balancear correctamente un árbol binario de búsqueda"
                            ...
                            Sino
                                ...
                                Escribir "- Altura actual: ", alturaMaxima
                                ...
                                Si alturaMaxima <= alturaIdeal + 1 Entonces
                                    Escribir "- Estado: ? El árbol está relativamente balanceado"
                                Sino
                                    Escribir "- Estado: ? El árbol necesita balanceo"
                                    Escribir ""
                                    Escribir "Sugerencia: Implemente un árbol AVL o Rojo-Negro"
                                    Escribir "en un lenguaje más robusto para balanceo automático."
                                FinSi
                            FinSi
                            Escribir ""
                            Escribir "Presione ENTER para continuar..."
